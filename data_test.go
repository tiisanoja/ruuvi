...
func TestHumidex(t *testing.T) {
	...
	want = 16.0
	got = math.Round(calculateHumidex(15.0, 10.0))

	if got != want {
		t.Errorf("Testing Humidex: got %f, wanted %f", got, want)
	}

	want = 59.0
	got = math.Round(calculateHumidex(43.0, 28.0))
	...
	want = 30.0
	got = math.Round(calculateHumidex(25.0, 16.0))
